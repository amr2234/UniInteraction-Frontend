        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {userTypes.map((type, index) => (
              <UserTypeCard key={index} userType={type} index={index} />
            ))}
          </div>
        </div>
      </section>
     {/* FAQ Section - Accordion with hidden answers */}
      {!isFaqsLoading && faqs.length > 0 && (
        <section className="py-16 sm:py-20 bg-white" style={{ backgroundColor: "#F4F4F4" }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2B2B2B] mb-3">{t("landing.faq.title")}</h2>
              <p className="text-[#6F6F6F] text-sm sm:text-base mb-4">
